...
PYBIND11_MODULE(safety_shield_py, handle) {
  ...
  py::class_<safety_shield::SafetyShield>(handle, "SafetyShield")
    ...
    .def("humanMeasurement", static_cast<void (safety_shield::SafetyShield::*)(const std::vector<std::vector<double>> human_measurement, int human_index, double time)>(&safety_shield::SafetyShield::humanMeasurement), py::arg("human_measurement"), py::arg("human_index"), py::arg("time"))
